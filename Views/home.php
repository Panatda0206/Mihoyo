    ...
    <?php foreach ($listPersonnage as $p): ?>
      <div class="card">
        <div class="top-actions">
          <a class="btn" href="index.php?action=edit-perso&idPerso=<?= $this->e($p->getId()) ?>" title="Modifier"><i class="bi bi-pen-fill">
          ...
          <a class="btn" href="index.php?action=del-perso&idPerso=<?= $this->e($p->getId()) ?>" title="Supprimer">
